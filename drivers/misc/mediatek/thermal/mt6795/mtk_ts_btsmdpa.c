...
{
	seq_printf(m,
		"[mtkts_btsmdpa_read] trip_0_temp=%d,trip_1_temp=%d,trip_2_temp=%d,trip_3_temp=%d,trip_4_temp=%d,\n",
				   ...
				   loff_t *data)
{
	...
	if (sscanf
		...
		("g_TRIP_0=%d,g_TRIP_1=%d,g_TRIP_2=%d,g_TRIP_3=%d,g_TRIP_4=%d,\n",
		g_THERMAL_TRIP[0], g_THERMAL_TRIP[1], g_THERMAL_TRIP[2], g_THERMAL_TRIP[3],
		g_THERMAL_TRIP[4]);
		mtkts_btsmdpa_dprintk
		("g_TRIP_5=%d,g_TRIP_6=%d,g_TRIP_7=%d,g_TRIP_8=%d,g_TRIP_9=%d,\n",
		g_THERMAL_TRIP[5], g_THERMAL_TRIP[6], g_THERMAL_TRIP[7], g_THERMAL_TRIP[8],
		g_THERMAL_TRIP[9]);
		mtkts_btsmdpa_dprintk
		("cooldev0=%s,cooldev1=%s,cooldev2=%s,cooldev3=%s,cooldev4=%s,\n", g_bind0,
		g_bind1, g_bind2, g_bind3, g_bind4);
		mtkts_btsmdpa_dprintk
		...
		mtkts_btsmdpa_dprintk("[mtkts_btsmdpa_write]");
		mtkts_btsmdpa_dprintk
		("trip_0_temp=%d,trip_1_temp=%d,trip_2_temp=%d,trip_3_temp=%d,trip_4_temp=%d,\n",
		 trip_temp[0], trip_temp[1], trip_temp[2], trip_temp[3], trip_temp[4]);
		mtkts_btsmdpa_dprintk
