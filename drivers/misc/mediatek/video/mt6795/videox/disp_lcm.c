...
#error
#endif
			/* DISPCHECK("[LCM] vact: %d, vbp: %d, vfp: %d, vact_line: %d, hact: %d, hbp: %d,",
			...
			DISPCHECK("[LCM] pll_select: %d,pll_div1: %d,pll_div2: %d,fbk_div: %d,fbk_sel: %d,rg_bir: %d\n",
			     p->dsi.pll_select, p->dsi.pll_div1, p->dsi.pll_div2, p->dsi.fbk_div, p->dsi.fbk_sel,
			     p->dsi.rg_bir);
			DISPCHECK("[LCM] rg_bic: %d, rg_bp: %d, PLL_CLOCK: %d, dsi_clock: %d, ssc_range: %d,",
			     p->dsi.rg_bic, p->dsi.rg_bp, p->dsi.PLL_CLOCK, p->dsi.dsi_clock, p->dsi.ssc_range);
